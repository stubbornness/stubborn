...
public class TestBrn1 {
    ...
    static {//
        gameCaseMap.put("0", "0_3_1_2_4_5");
        gameCaseMap.put("1", "0_3_1_2_4_5");
        gameCaseMap.put("2", "0_3_1_2_4_5");
    ...
    public Map<String, Object> commonOutputCase () {
        ...
        Map<Integer,Integer> maps  = sortBrnCardDetails(cardList);
        commonMap.put("diceMap", diceMap);
        commonMap.put("cardList", cardList);
        commonMap.put("maps", maps);
        return commonMap;
    }
    ...
    public Map<Integer,Integer> sortBrnCardDetails (List<BrnCardDetail> list) {
        ...
        for (BrnCardDetail brnCardDetail : list) {
            map.put(i,brnCardDetail.getIndex());
            i++;
        }
        return map;
    }
...
*/
    ...
    public List<BrnCardDetail> outputCardInfo () {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            if (maxKey == null) {
                brnCardDetail = new BrnCardDetail(i, cardDetails, 0, "", maxNum, maxNumColor);
            } else {
                brnCardDetail = new BrnCardDetail(i, cardDetails, maxValue, brnCardMap.get(maxKey), maxNum, maxNumColor);
            }
